...
{
    public partial class frmTipoDeTransaccion : Form
    {
        public frmTipoDeTransaccion()
        {
            InitializeComponent();
        }

        private string NOMBRE_ENTIDAD_PRIVILEGIO = "TipoDeTransaccion";
        private string NOMBRE_ENTIDAD = "Administrar los tipos de transacciones";
        private string NOMBRE_LLAVE_PRIMARIA = "idTipoDeTransaccion";
        ...
        public TipoDeTransaccionEN[] oTipoDeTransaccion = new TipoDeTransaccionEN[0];
        ...
        private void AgregarRegistrosAlDTUsuario()
        {
            ...
            if (oTipoDeTransaccion.Length > 0)
            {
        ...
        private DataTable ConvertirClassADT()
        {
            ...
            System.Xml.Serialization.XmlSerializer serializer = new System.Xml.Serialization.XmlSerializer(oTipoDeTransaccion.GetType());
            System.IO.StringWriter sw = new System.IO.StringWriter();
            serializer.Serialize(sw, oTipoDeTransaccion);
        ...
        private string WhereDinamico() {
            ...
            if (Controles.IsNullOEmptyElControl(chkIdentificador) == false && Controles.IsNullOEmptyElControl(txtIdentificador) == false) {
                Where += string.Format(" and idTipoDeTransaccion like '%{0}%' ", txtIdentificador.Text.Trim());
            }

            if (Controles.IsNullOEmptyElControl(chkDesTipoDeTransaccion) == false && Controles.IsNullOEmptyElControl(txtDesTipoDeTransaccion) == false)
            {
                Where += string.Format(" and DesTipoDeTransaccion like '%{0}%' ", txtDesTipoDeTransaccion.Text.Trim());
            }
        ...
        private string TituloDinamico()
        {
            ...
            if (Controles.IsNullOEmptyElControl(chkDesTipoDeTransaccion) == false && Controles.IsNullOEmptyElControl(txtDesTipoDeTransaccion) == false)
            {
                Titulo += string.Format(" Descripción: '{0}', ", txtDesTipoDeTransaccion.Text.Trim());
            }
        ...
        private void LLenarListado() {
            ...
            try
            {
                ...
                TipoDeTransaccionEN oRegistrosEN = new TipoDeTransaccionEN();
                TipoDeTransaccionLN oRegistrosLN = new TipoDeTransaccionLN();
                ...
                foreach (DataGridViewColumn c1 in dgvLista.Columns)
                {
                    if (c1.Visible == true)
                    {
                        if (c1.Name.Trim().ToUpper() != "Seleccionar".ToUpper())
                        {
                            ...
                            {
                                oFormato = new FormatoDGV(c1.Name.Trim(), "TipoDeTransaccion");
                            }
        ...
        private void MostrarFormularioParaOperacion(string OperacionesARealizar)
        {
            ...
            frmTipoDeTransaccionOperacion ofrmTipoDeTransaccionOperacion = new frmTipoDeTransaccionOperacion();
            ofrmTipoDeTransaccionOperacion.OperacionARealizar = OperacionesARealizar;
            ofrmTipoDeTransaccionOperacion.NOMBRE_ENTIDAD_PRIVILEGIO = NOMBRE_ENTIDAD_PRIVILEGIO;
            ofrmTipoDeTransaccionOperacion.NombreEntidad = NOMBRE_ENTIDAD;
            ofrmTipoDeTransaccionOperacion.ValorLlavePrimariaEntidad = this.ValorLlavePrimariaEntidad;
            ofrmTipoDeTransaccionOperacion.MdiParent = this.ParentForm;
            ofrmTipoDeTransaccionOperacion.Show();
        ...
        private void frmTipoDeTransaccion_Shown(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dgvLista.Rows.Count > 0)
                {
                    foreach (DataGridViewRow Fila in dgvLista.Rows)
                    {
                        ...
                        {
                            a++;
                            Array.Resize(ref oTipoDeTransaccion, a);

                            oTipoDeTransaccion[a - 1] = new TipoDeTransaccionEN();
                            oTipoDeTransaccion[a - 1].idTipoDeTransaccion = Convert.ToInt32(Fila.Cells["idTipoDeTransaccion"].Value);
                            oTipoDeTransaccion[a - 1].DesTipoDeTransaccion = Fila.Cells["DesTipoDeTransaccion"].Value.ToString();                           
        ...
        private void frmTipoDeTransaccion_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void txtDesTipoDeTransaccion_KeyUp(object sender, KeyEventArgs e)
        {
            if (Controles.IsNullOEmptyElControl(txtDesTipoDeTransaccion))
            {
                chkDesTipoDeTransaccion.CheckState = CheckState.Unchecked;
            }
            else { chkDesTipoDeTransaccion.CheckState = CheckState.Checked; }

            if (chkDesTipoDeTransaccion.CheckState == CheckState.Checked && tsbFiltroAutomatico.CheckState == CheckState.Checked)
            {
                LLenarListado();
            }
        }
